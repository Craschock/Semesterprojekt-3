...
#Izzy here:establishing the sound variable for the scratch
@onready var mine_boss_attack_slash: AudioStreamPlayer2D = $"../../mine_boss_attack_slash"
...
func enter() -> void:
	...
	#Izzy here: playing sound for the over ground scratch attack
	mine_boss_attack_slash.play()
